...
# Copyright 2014 Aaron Ten Clay <aarontc@aarontc.com>
...
if [[ $PV = *9999* ]]; then
	...
	SRC_URI="http://ceph.com/download/${P//_/-}.tar.bz2"
	KEYWORDS="amd64 x86"
fi
...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="btrfs debug fuse gtk libatomic radosgw static-libs tcmalloc xfs"
